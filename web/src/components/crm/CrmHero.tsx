...
import CrmWindow from "@/components/landing/visuals/CrmWindow";
    ...
    <section className="hero-stage" aria-labelledby="crm-heading">
      ...
      <div className="relative mx-auto w-full max-w-6xl px-5 pb-24 pt-16 sm:px-8 sm:pt-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-xl text-base text-muted sm:text-lg">{crmHero.standfirst}</p>

          <div className="mt-9 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <GlowButton href={crmHero.primaryCta.href}>{crmHero.primaryCta.label}</GlowButton>
            <GlassButton href={crmHero.secondaryCta.href}>{crmHero.secondaryCta.label}</GlassButton>
          </div>
        </div>

        <div id="crm-demo" className="mt-16 sm:mt-20">
          <CrmWindow sequence labelledBy="crm-heading" />
        </div>
      </div>
    </section>
  );
